...
def main():
    ...
    for idx, path in enumerate(paths):
        ...
        try:
            ...
            # Determine output extension for SR image
            if args.ext == 'auto':
                # Remove dot from original_lr_extension_with_dot
                current_output_extension = original_lr_extension_with_dot[1:] 
            else:
            ...
            # If suffix is empty, imagename.ext, otherwise imgname_suffix.ext
